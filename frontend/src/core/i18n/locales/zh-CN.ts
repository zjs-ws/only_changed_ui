...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用你的 AI 智能体工作区。内置与自定义 Skills 助你搜索、分析，并生成幻灯片、网页等成果。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来扩展能力。通过自定义技能，\n它可以帮你搜索网络、分析数据，并生成各类作品。",
  },
  ...
  sidebar: {
    ...
    pin: "置顶",
    unpin: "取消置顶",
    removeFromPinned: "从置顶移除",
    noPinnedChats: "暂无置顶对话。",
    connection: "连接",
    online: "在线",
    offline: "离线",
    theme: "主题",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在应用中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作应用。",
  ...
  settings: {
    ...
    memory: {
      title: "记忆",
      description:
        "智能体会在后台不断从你的对话中自动学习。这些记忆能帮助它更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    notification: {
      title: "通知",
      description:
        "应用只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
