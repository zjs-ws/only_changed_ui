...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome back! This is your AI agent workspace. With built-in and custom skills, it can help you search on the web, analyze data, and generate artifacts like slides and web pages.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to extend your agent workspace. With customized skills,\nit can help you search on the web, analyze data, and generate artifacts.",
  },
  ...
  inputBox: {
    ...
    surpriseMe: "Creative page",
    surpriseMePrompt: "Create a creative page",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available in the app",
  },
  ...
  settings: {
    ...
    memory: {
      title: "Memory",
      description:
        "The agent can learn from your conversations in the background. These memories help it understand you better and deliver a more personalized experience.",
    ...
    notification: {
      title: "Notification",
      description:
        "The app only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
